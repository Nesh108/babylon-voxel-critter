////////////////////////////////////////////////////////////////////////
// https://github.com/maxogden/voxel/blob/master/meshers/greedy.js 
// together with
// https://github.com/TriBlade9/VoxelMesher-BabylonJS/blob/master/js/greedy_tri.js
////////////////////////////////////////////////////////////////////////

// Cache buffer internally
let mask = new Int32Array(4096);

function GreedyMesher(volume, dims) {
  var vertices = [], faces = []
    , dimsX = dims[0]
    , dimsY = dims[1]
    , dimsXY = dimsX * dimsY;
